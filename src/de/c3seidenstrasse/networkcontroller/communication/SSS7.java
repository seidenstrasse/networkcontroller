...
public class SSS7 {
	...
	public static SSS7 getInstance() {
		if (SSS7.instance == null)
			SSS7.instance = new SSS7();
		return SSS7.instance;
	}
	...
	// All methods should be synchronized as libsss7 will a single mutex
	// instance
	// for all of them
	...
	public synchronized void send(final byte[] data) {
		final Pointer p = new Memory(this.payloadLength);
